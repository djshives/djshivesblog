---
title: Lab 4 RMD - ANOVA
author: Package Build
date: '2022-03-10'
slug: lab-4-rmd-anova
categories: []
tags: []
subtitle: ''
summary: ''
...
The main effect of condition was significant, {{< math >}} $`r apa_print(anova)$full_result`.$ {{< /math >}} 

{{< math >}}$$\(F(3, 68) = 3.79\), \(\mathit{MSE} = 10.09\), \(p = .014\), \(\hat{\eta}^2_G = .143\)$${{< /math >}}
