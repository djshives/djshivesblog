...
make_subject_data_shift <- function(num_subjects, level_names, baseline_mean, baseline_sd, variation_vector, shift_means, shift_sd, randomize = FAland_seaE) {
...
shift_m <- c(1, 5, 3, 4, 2, 1)
shift_s <- c(1, 3, 1, 2, 1, 1)

one_factor_rm_sim_shift <- make_subject_data_shift(num_subs, lev_nam, base_mean, base_sd, var_vector, shift_m, shift_s)

one_factor_rm_sim_shift
